...
class Etiqueta {
    ...
    private $start_etiqueta = "\\x1B' + '\\x40";
    private $cut = "'\\x1B' + '\\x69'"; // cut paper
    private $end_etiqueta = "'\\x0A' + '\\x0A' + '\\x0A' + '\\x0A' + '\\x0A' + '\\x0A' + '\\x0A";
    ...
    public function GenerateDestinatario() {
        //Separador
        $text = $this->line;
        $this->etiqueta .= $this->start_character . $text . $this->end_character;
    ...
    private function imprime($tag) {
        foreach ($tag as $lines) {
            ...
            $this->etiqueta .= $this->start_character . $line . $this->end_character;
            //Linea en blanco
            $text = $this->line_break;
            $this->etiqueta .= $this->start_character . $text . $this->end_character;

            //Nombre del producto
            $this->etiqueta .= $this->start_character . '     ' . strtoupper($desc) . $this->end_character;
            //Linea en blanco
            $text = $this->line_break;
            $this->etiqueta .= $this->start_character . $text . $this->end_character;
        }
    ...
    public function generate() {
        ...
        // Etiquetas
        //$this->imprime($tag);
        $this->etiqueta .= $this->end_etiqueta . $this->end_character;
        $this->etiqueta .= $this->cut;
