...
/**
 * Remitentes form base class.
 *
 * @method Remitentes getObject() Returns the current form's model object
 *
 * @package    zebra
 * @subpackage form
 ...
 */
abstract class BaseRemitentesForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('remitentes[%s]');
