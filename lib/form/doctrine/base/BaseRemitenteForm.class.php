...
/**
 * Remitente form base class.
 *
 * @method Remitente getObject() Returns the current form's model object
 *
 * @package    zebra
 * @subpackage form
 ...
 */
abstract class BaseRemitenteForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('remitente[%s]');
